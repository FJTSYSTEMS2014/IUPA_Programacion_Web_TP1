...
//con Arrow
const separarPorComas = (str1, str2, str3) => {
  return str1 + ', ' + str2 + ', ' + str3;
};
const resultado3 = separarPorComas('Hay', 'que', 'programar!');
imprimir('3:', resultado3);
...
*/
// modificado
function separarPorComasTodo(...texto) {
  return texto;
}

const resultado4 = separarPorComasTodo('Hola', 'como', 'estas?');
imprimir('4:', resultado4);
// ================================================================
...
function quienEs() {
  return `Nombre: ${persona.nombre},Ciudad: ${persona.direccion.ciudad}`;
}
